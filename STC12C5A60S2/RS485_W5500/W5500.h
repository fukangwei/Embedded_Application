...
sbit W5500_INT  = P3 ^ 3;
sbit W5500_SCS  = P3 ^ 4;
sbit W5500_SCLK = P3 ^ 5;
sbit W5500_MISO = P3 ^ 6;
sbit W5500_MOSI = P3 ^ 7;
...
extern unsigned char S1_DIP[4];
extern unsigned char S1_DPort[2];
extern unsigned char S1_DPort[2];
...
extern unsigned char Detect_Gateway_S0 ( void );
extern unsigned char Detect_Gateway_S1 ( void );
