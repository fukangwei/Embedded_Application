...
sbit W5500_INT  = P0 ^ 1;
sbit W5500_SCS  = P0 ^ 2;
sbit W5500_SCLK = P0 ^ 3;
sbit W5500_MISO = P0 ^ 4;
sbit W5500_MOSI = P0 ^ 5;
...
extern unsigned char S0_Mode;  /* 端口0的运行模式 */

#define TCP_SERVER 0x00 /* TCP服务器模式 */
#define TCP_CLIENT 0x01 /* TCP客户端模式 */
#define UDP_MODE   0x02 /* UDP(广播)模式 */

extern unsigned char S0_State; /* 端口0状态记录 */
...
extern unsigned char W5500_Interrupt; /* W5500中断标志(0是无中断，1是有中断) */
