...
static void ENC28J60_SPI2_Init(void)
{
   ...
   RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOC, ENABLE );
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12|GPIO_Pin_0;				 // PB12,0 推挽   上拉
 	GPIO_Init(GPIOB, &GPIO_InitStructure);					 //根据设定参数初始化GPIOB.12,0
 	GPIO_SetBits(GPIOB,GPIO_Pin_12|GPIO_Pin_0);						 //PB.12,0上拉
